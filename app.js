...
const i18n = {
  ...
  'en': { 
      ...
      smartAssistant: 'Rikka Smart Assistant (Beta)',
  ...
  'ja': { 
      ...
      smartAssistant: 'Rikkabot スマートアシスタント (Beta)',
  ...
  'ru': { 
      ...
      smartAssistant: 'Rikka bot Интеллектуальный ассистент (Бета)',
...
const API_URL = 'https://api.someprovider.com/v1/chat/completions'; // 替换为硅基流动实际的 API 地址
